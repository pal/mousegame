...
export const DIFFICULTY: Record<Difficulty, BoardConfig> = {
  EASY:   { size: 9,  startingScore: 1000, scorePerWall: 5,  scorePerMove: 5  },
  NORMAL: { size: 11, startingScore: 1000, scorePerWall: 10, scorePerMove: 10 },
  HARD:   { size: 13, startingScore: 800,  scorePerWall: 15, scorePerMove: 15 },
};
